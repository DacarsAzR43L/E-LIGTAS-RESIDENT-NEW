...
if (isset($_POST['name']) && isset($_POST['uid']) && isset($_POST['address']) &&
    ...
    // Check if the uid exists in the user_profile table
    $checkUidQuery = "SELECT * FROM resident_profile WHERE uid='$uid'";
    $checkResult = mysqli_query($db, $checkUidQuery);
    ...
    if ($checkResult && mysqli_num_rows($checkResult) > 0) {
        ...
        // Update data in the user_profile table with the new image path
        $updateQuery = "UPDATE resident_profile SET name='$name', address='$address', phoneNumber='$phonenumber', image='$targetPath' WHERE uid='$uid'";
        ...
        // UID does not exist, insert new data
