...
class _HistoryState extends State<History> with SingleTickerProviderStateMixin {
  ...
  Future<void> removeDataFromDatabase(int reportId) async {
    try {
      ...
      final String apiUrl = 'http://192.168.100.185/e-ligtas-resident/delete_pending_history.php?report_id=$reportId';
  ...
  Future<void> fetchData() async {
    ...
    try {
      final String apiUrl =
          'http://192.168.100.185/e-ligtas-resident/get_pending_history.php?uid=${widget.uid}';
      final response = await http.get(Uri.parse(apiUrl));
  ...
  Future<void> fetchAcceptedData() async {
    ...
    try {
      final String apiUrl = 'http://192.168.100.185/e-ligtas-resident/get_accepted_history.php?uid=${widget.uid}';
      final response = await http.get(Uri.parse(apiUrl));
  ...
  Future<void> fetchArchivedData() async {
    ...
    try {
      final String apiUrl = 'http://192.168.100.185/e-ligtas-resident/get_archived_history.php?uid=${widget.uid}';
      final response = await http.get(Uri.parse(apiUrl));
