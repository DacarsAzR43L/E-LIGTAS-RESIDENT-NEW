...
//Picked Profile
  ...
  Future<void> uploadImage() async {
    showDialog(
      ...
      Dio dio = Dio();
      var response = await dio.post('http://192.168.100.185/e-ligtas-resident/upload_profile.php', data: formData);
  ...
  Future<void> checkPhoneNumber(String phone_number) async {
    ...
    final response = await http.get(Uri.parse(
        'http://192.168.100.185/e-ligtas-resident/check_number.php?phone_number=$phone_number'));
