...
class _VerifyScreenState extends State<VerifyScreen> {
  ...
  Future<void> fetchData(BuildContext context) async {
    ...
    final arguments = ModalRoute.of(context)?.settings.arguments as RouteArguments;
  ...
  Future<void> checkEmailVerified() async {
    ...
    if (user!.emailVerified) {
      ...
      Navigator.pushAndRemoveUntil(context,
          MaterialPageRoute(builder: (context) => SetUpProfile()),(route) => false);
    ...
    return SafeArea(
      child: Scaffold(
          body: WillPopScope(
            ...
            Center(
              child: Text("We have just send email verification link on $email."
            ...
            SizedBox(height: 30.0,),
                    ...
                    InkWell(
                      ...
                      child: Text(" Back to Sign up", style:TextStyle(
